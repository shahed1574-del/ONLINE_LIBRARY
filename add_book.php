...
if ($count == 1) {
    header('Location:http://localhost/ONLINE-LIBRARY1/new_book.php?re=1');
    exit();
}
...
$upload_file = "../img/" . $cover_photo; // نرجع خطوة للخلف من fun إلى المجلد الرئيسي

move_uploaded_file($filetmp, $upload_file);
...
header('Location:http://localhost/ONLINE-LIBRARY1/new_book.php?re=2');
?>